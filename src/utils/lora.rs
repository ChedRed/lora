...
impl Lora {
    pub fn new(
        code: String,
        verbose: bool,
        main_cmd: Sender<LoraToMainCommand>,
        main_rtrn: Receiver<MainToLoraCommand>,
        main_call: Receiver<MainToLoraCall>,
        main_back: Sender<LoraToMainCall>,
    ) -> Self {
        ...
        _ = set_physics.set(
            ...
            _lua.create_function({
                ...
                let rx = main_rtrn.clone(); // lora.set.physics.gravity
                move |_, (x, y)| {
        ...
        _ = set_physics.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.set.physics.hertz
                move |_, hz| {
        ...
        _ = set_window.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.set.window.title
                move |_, text| {
        ...
        _ = set_window.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.set.window.size
                move |_, (w, h)| {
        ...
        _ = set_window.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.set.window.resizable
                move |_, is| {
        ...
        _ = set_camera.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.set.camera.position
                move |_, (x, y)| {
        ...
        _ = get_window.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.get.window.size
                move |_, ()| {
                    let mut nw: u32 = 0;
                    let mut nh: u32 = 0;
        ...
        _ = get_key.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.get.key.state
                move |_, key| {
        ...
        _ = get_camera.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.get.camera.position
                move |_, ()| {
        ...
        _ = new.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.new.shape
                move |_, (image, scale)| {
        ...
        _ = new.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.new.mesh
                move |_, (vertices, indices): (Vec<[f32; 8]>, Vec<u32>)| {
                    _ = tx.send(LoraToMainCommand::NewMesh {
        ...
        _ = new.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.new.collider
                move |_, (shape, collision): (UserDataRef<LoraShapeRef>, String)| {
                    _ = tx.send(LoraToMainCommand::NewCollider {
                        shape: shape.clone(),
                        collision,
                    });
        ...
        _ = new.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.new.spawner
                move |_,
                      (shape, collider): (
                    Option<UserDataRef<LoraShapeRef>>,
                    Option<UserDataRef<LoraColliderRef>>,
                )| {
                    _ = tx.send(LoraToMainCommand::NewSpawner {
                        shape: shape.as_deref().cloned(),
                        collider: collider.as_deref().cloned(),
                    });
        ...
        _ = new.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.new.sound
                move |_, sound| {
        ...
        _ = draw.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.draw.rect
                move |_, (x, y, w, h, r, color): (f32, f32, f32, f32, f32, [f32; 4])| {
                    _ = tx.send(LoraToMainCommand::DrawPrimitive {
                        x,
                        y,
                        w,
                        h,
        ...
        _ = draw.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.draw.circle
        ...
        _ = draw.set(
            ...
            _lua.create_function({
                let tx = main_cmd.clone();
                let rx = main_rtrn.clone(); // lora.draw.line
